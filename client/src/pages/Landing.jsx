  ...
  <div className="bg-bg-secondary border border-border rounded-xl overflow-hidden shadow-2xl w-full max-w-md mx-auto">
    ...
    <div className="p-5 font-mono text-sm space-y-1.5">
      <p className="text-text-muted">
        $ devsync find --skill react --role frontend
      </p>
      ...
      <p className="text-text-muted">
        $ devsync post --project "AI Study Planner"
      </p>
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-text-secondary text-lg mb-8 max-w-lg">
            DevSync is where developers build profiles, recruit teammates for
            real projects, and share progress — no fluff, just people who ship.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6 py-16 grid sm:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-text-secondary text-sm">
              Skills, GitHub, portfolio, and what you're working on — all in one
              place.
            </p>
          </div>
          <div>
            ...
            <p className="text-text-secondary text-sm">
              Search by skill, send connection requests, build your network of
              collaborators.
            </p>
          </div>
          <div>
            ...
            <p className="text-text-secondary text-sm">
              Post your project, list the roles you need, and let developers
              apply directly.
            </p>
          </div>
        </div>
